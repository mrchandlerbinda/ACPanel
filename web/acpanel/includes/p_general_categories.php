...
{
	$search_addcat_id = array_search("p_general_categories_add", $value);
	$search_edit_id = array_search("p_general_categories_edit", $value);
	if ($search_addcat_id)
	{
...
$smarty->assign("head_title","@@head_general_category@@");
