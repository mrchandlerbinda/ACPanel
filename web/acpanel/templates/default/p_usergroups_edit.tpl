		...
		$('#forma-edit').submit(function() {
			...
			else
			{				$('.infoMsg').html('');
				...
				$('select', this).each(function() {
					if($(this).val() == null) data += '&' + $(this).attr('name') + '=';
				});
				...
				<table class="tablesorter" cellpadding="0" cellspacing="0" width="100%">
					<tr class="even">
						...
						<td width='55%' align='left' style='border-left-width:0;'>
							<input type="hidden" class="text" name="usergroupid" value="{$array_group.usergroupid}" />
							<input class='text small' type='text' name='usergroupname' value='{$array_group.usergroupname}' size='30' /><span class="infoMsg note error"></span>
						</td>
					</tr>
